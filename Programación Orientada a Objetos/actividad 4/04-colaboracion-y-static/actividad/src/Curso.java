...
public class Curso {
    ...
    public boolean inscribirEstudiante(Estudiante unEstudiante) {
        if ((unEstudiante.getNombre() == null || unEstudiante.getNombre().isEmpty()) || (unEstudiante.getApellido() == null || unEstudiante.getApellido().isEmpty())) {
            return false;
        }
        ...
        return true; //Devuelve verdadero, si pasa todos los chequeos
